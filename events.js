...
//Keypress in input field
var fieldEl = document.getElementById("keypress-input");

function inputKeypress() {
	console.log(event);
	outputDiv.innerHTML= `<p class="msg">${fieldEl.value}</p>`
}

fieldEl.addEventListener("keypress", inputKeypress);
...
document.getElementById("make-large").addEventListener("click", function() {
	piggie.classList.toggle("bigger");
});
